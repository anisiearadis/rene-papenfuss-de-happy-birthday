<div class="position-relative mt-auto">
    <div class="cake object-fit-contain">
        <div class="plate"></div>
...
<style lang="scss">
  ...
  @mixin foodColoring($color) {
    ...
    box-shadow: 0 2px 0 lighten($color, 5%),
    0 4px 0 darken($color, 8.2%),
    0 6px 0 darken($color, 8.4%),
    0 8px 0 darken($color, 8.6%),
    0 10px 0 darken($color, 8.8%),
    0 12px 0 darken($color, 9%),
    0 14px 0 darken($color, 9.2%),
    0 16px 0 darken($color, 9.4%),
    0 18px 0 darken($color, 9.6%),
    0 20px 0 darken($color, 9.8%),
    0 22px 0 darken($color, 10%),
    0 24px 0 darken($color, 10.2%),
    0 26px 0 darken($color, 10.4%),
    0 28px 0 darken($color, 10.6%),
    0 30px 0 darken($color, 10.8%);
  }
  ...
  .plate {
    ...
    border-radius: 50%;
    box-shadow: 0 2px 0 darken(#ccc, 10%),
  ...
  .icing {
    ...
    &:before {
      ...
      box-shadow: 0 0 4px lighten($vanilla, 5%),
